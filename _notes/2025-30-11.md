...
I want to talk about the uses of matrices in machine learning and beyond, why the singular values of the matrix are important. What the singular values actually mean and what their implications are for optimisation.
So a linear transformation is just a big set of numbers. It can have many interesting properties.
<div id="svd-demo"></div>
